...
#include "params/GoodbyeObject2.hh"
#include "sim/sim_object.hh"

class GoodbyeObject2 : public SimObject
{
  private:
    void processEvent();
    ...
    EventWrapper<GoodbyeObject2, &GoodbyeObject2::processEvent> event;
  ...
  public:
    GoodbyeObject2(GoodbyeObject2Params *p);
    ~GoodbyeObject2();
